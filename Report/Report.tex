...
Imagine that we have some outside information about a system, and we can generate observations that are dependent on the state of the system. However, the actual state of the system is hidden from us. Then how can we go about finding out the hidden state of the system using our observations? It turns out we can through a process called \textbf{particle filtering}.
...
We will begin by formally defining the problem setting and then deriving the particle filter algorithms.
